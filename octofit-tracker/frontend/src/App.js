            ...
            <div className="collapse navbar-collapse" id="navbarNav">
              ...
              <ul className="navbar-nav">
                <li className="nav-item">
                  <a className="nav-link btn btn-outline-light ms-2" href="https://reactjs.org" target="_blank" rel="noopener noreferrer">Learn React</a>
                </li>
              </ul>
            </div>
          </div>
            ...
            <Route path="/" element={
              <div className="card mt-4">
                <div className="card-body">
                  ...
                  <a className="btn btn-primary" href="/activities">Get Started</a>
                </div>
              </div>
            } />
          </Routes>
